...
# C:\Users\abanach\Desktop\jenkins_ci\tests> pytest .\tank_creation_process_rel.py - command to start the test
...
def test_method_1(browser):
    ...
    # Validate data
    name_details = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-counterparty-details/div/section[2]/section/div[2]/app-tanks/app-scroll-table/div/div/table/tbody/tr[8]/td[1]/app-avatar-content/div/div[2]/span[1]").text
    product_details = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-counterparty-details/div/section[2]/section/div[2]/app-tanks/app-scroll-table/div/div/table/tbody/tr[8]/td[2]/div/span").text
    capacity_details = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-counterparty-details/div/section[2]/section/div[2]/app-tanks/app-scroll-table/div/div/table/tbody/tr[8]/td[3]/div/span").text

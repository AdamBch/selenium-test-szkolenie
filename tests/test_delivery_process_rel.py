...
def test_method_1(browser):
    ...
    quality_button = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-dashboard-base/app-dashboard/div/app-delivery-list/div[2]/div/app-scroll-table/div/div/table/tbody/tr[1]/td[7]/div/a[1]/span[2]")

...
def test_method_1(browser):
    ...
    delete_button = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-counterparty-details/div/section[2]/section/div[2]/app-tanks/app-scroll-table/div/div/table/tbody/tr[2]/td[4]/div/div/button[2]/mat-icon")
    delete_button.click()
    time.sleep(1)

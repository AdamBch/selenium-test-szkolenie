...
# C:\Users\abanach\Desktop\jenkins_ci\tests> pytest .\port_creation_process_rel.py - command to start the test
...
def test_method_1(browser):
    ...
    operators_button = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/app-sidebar/section/nav/a[3]")
    ...
    phone_details = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-operators/div/section/section/app-ports/div/section/section/app-scroll-table/div/div/table/tbody/tr/td[5]/div/span").text

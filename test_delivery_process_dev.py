...
from variables import dev_iot_password 
from variables import dev_test_vessel 
from variables import dev_shipping_agent 
from variables import dev_designated_inspector 
from variables import dev_csa 
from variables import dev_product_quantity 
from variables import dev_bidec 
from variables import dev_depot 
from variables import dev_laycan_date_min 
from variables import dev_laycan_date_max 
from variables import dev_dapoa_option_bank 
from variables import dev_dapoa_quantity 
from variables import dev_ittlc_quantity 
from variables import dev_ittlc_option_bank 
from variables import dev_tt_quantity 
from variables import dev_invoice_ref_number 
from variables import dev_bidec_email 
from variables import dev_bidec_password 
from variables import dev_bank_email 
from variables import dev_bank_password 
from variables import dev_depot_email 
from variables import dev_depot_password 
from variables import dev_agent_email 
from variables import dev_agent_password 
from variables import dev_inspector_email 
from variables import dev_inspector_password 

fake = Faker('pl_PL')

# C:\Users\abanach\Desktop\jenkins_test_dev\srms.tests.e2e\tests> pytest .\test_delivery_process_dev.py - command to start the test

# main variables
srms_page  = dev_srms_page 
iot_email  = dev_iot_email 
iot_password  = dev_iot_password 
test_vessel  = dev_test_vessel 
shipping_agent  = dev_shipping_agent 
designated_inspector  = dev_designated_inspector 
csa  = dev_csa 
product_quantity  = dev_product_quantity 
bidec  = dev_bidec 
depot  = dev_depot 
laycan_date_min  = dev_laycan_date_min 
laycan_date_max  = dev_laycan_date_max 
dapoa_option_bank  = dev_dapoa_option_bank 
dapoa_quantity  = dev_dapoa_quantity 
ittlc_quantity  = dev_ittlc_quantity 
ittlc_option_bank  = dev_ittlc_option_bank 
tt_quantity  = dev_tt_quantity 
invoice_ref_number  = dev_invoice_ref_number 
bidec_email  = dev_bidec_email 
bidec_password  = dev_bidec_password 
bank_email  = dev_bank_email 
bank_password  = dev_bank_password 
depot_email  = dev_depot_email 
depot_password  = dev_depot_password 
agent_email  = dev_agent_email 
agent_password  = dev_agent_password 
inspector_email  = dev_inspector_email 
inspector_password  = dev_inspector_password 
...
def test_method_1(browser):
    ...
    # Select a Depot
    depot_select_field = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-dashboard-base/app-create-delivery/app-step-form/div/form/md-input-container/div[2]/div/div[2]/div[2]/app-async-select/mat-form-field/div[1]/div[2]/div[1]/input")
    depot_select_field.send_keys(depot)
    time.sleep(1)
    depot_select_field.send_keys(Keys.ENTER)
    time.sleep(1)
